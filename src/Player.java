...
public class Player {
    ...
    public boolean play(String savePath) {
...
//            System.out.println(file);
            ...
            AudioInputStream audioInputStream = AudioSystem.getAudioInputStream(new File(savePath));
    ...
    public boolean play(BufferedInputStream bis){
        try {
